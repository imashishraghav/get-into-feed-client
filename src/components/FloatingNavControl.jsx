...
export default function FloatingNavControl() {
  ...
  return (
    <div
      className="fixed right-4 md:right-6 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center bg-[#09090B] border-2 border-[#D4FF00] rounded-full p-1.5 shadow-[0_8px_30px_rgba(0,0,0,0.8)] backdrop-blur-md transition-all duration-300 select-none"
      style={{
        width: "46px",
