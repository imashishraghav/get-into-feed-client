...
export default function CaseStudiesGrid({ caseStudies }) {
  ...
  // ✅ FIX: Hamesha <section> return karein taaki Framer Motion ka ref attach ho sake.
  // Koi 'return null' use nahi karna hai ab!
  return (
    <section 
      ref={containerRef}
    ...
    >
      {/* Agar data nahi aaya hai, toh ek empty/loading state dikhayein */}
      {!caseStudies || caseStudies.length === 0 ? (
        <div className="max-w-7xl mx-auto px-6 text-center py-20">
          <p className="text-navy/50 font-medium">Loading case studies...</p>
        </div>
      ) : (
